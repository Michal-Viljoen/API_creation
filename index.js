...
app.put('/jokes/:id', (req, res) =>{
  ...
  const currentJoke = jokes.findIndex((joke) => joke.id === id);
  jokes[currentJoke] = replacementJoke;
...
app.patch('/jokes/:id', (req, res) =>{
  ...
  currentJoke.jokeType = req.body.jokeType;
  currentJoke.jokeText = req.body.jokeText;
